...
class Mat(object):
    """Mat is a matrix object. The main purpose of this object is to represent a pose in the 3D space.
    ...
    Poses are commonly used in robotics to place objects and reference frames with respect to each other."""
